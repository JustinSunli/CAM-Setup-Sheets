...
namespace CAM_Setup_Sheets
{
    ...
    public class DocumentEventHandler
    {
        ...
        protected CAM_Setup_Sheets_Addin userAddin;
    ...
    {
        AssemblyDoc doc;
        CAM_Setup_Sheets_Addin swAddin;

        public AssemblyEventHandler(ModelDoc2 modDoc, CAM_Setup_Sheets_Addin addin)
            : base(modDoc, addin)
        {
    ...
    public class DrawingEventHandler : DocumentEventHandler
    {
        ...
        public DrawingEventHandler(ModelDoc2 modDoc, CAM_Setup_Sheets_Addin addin)
            : base(modDoc, addin)
        {
    ...
    {
        ISldWorks iSwApp;
        CAM_Setup_Sheets_Addin userAddin;
        ModelView mView;
